        ...
        childCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (childCheckBox.isChecked()) {
                    com.example.mykhail.tracklocationv20.Singleton.getInstance().getSelectedUsers().add(childTextView.getText().toString());
                } else
                    com.example.mykhail.tracklocationv20.Singleton.getInstance().getSelectedUsers().remove(childTextView.getText().toString());
            }
        });
