...
public class Singleton {
    private static com.example.mykhail.tracklocationv20.Singleton mInstance = null;
    ...
    public static com.example.mykhail.tracklocationv20.Singleton getInstance() {
        if (mInstance == null) {
            mInstance = new com.example.mykhail.tracklocationv20.Singleton();
        }
        return mInstance;
    }
